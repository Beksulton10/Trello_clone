...
const Main = () => {
  ...
  const saveListTitle = (listIndex) => {
    const updatedLists = [...activeBoard.list];
    updatedLists[listIndex].title = editingListTitle;
  ...
  return (
    <div className="flex flex-col w-full" style={{ backgroundColor: `${activeBoard.bgcolor}` }}>
      <div className="bg-[#4bbf6b] text-center">
        <h1 className="text-[40px] text-[#fff] title">React Trello Clone</h1>
      </div>
                                ...
                                <div className="flex justify-between p-1">
                                  {editingListId === list.id ? (
                                    <input
                                      ...
                                      className="bg-black border-b-2 border-gray-500 focus:outline-none"
                                    />
                                  ) : (
